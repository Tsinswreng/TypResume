...
- 源碼爲純文本, 便于版本控制、易于調整樣式(Word直接顯示排版效果、不方便視察與修改內部的樣式邏輯)
- 格式與內容分離、便于製作模板
...
- 一真一假兩套個人信息獨立存儲 無侵入主文檔。真實信息用于現實中實際投遞等、假信息用于在網絡上展示等。
...
```
效果:
#image("assets/2025-09-19-21-55-10.png")

有的行 右側空白較多。當*有壓縮空間的需求*時、可以用以下辦法來做一個假的 支持行內多項的列表:
```typst
#[
	//列表項
	#let I(doc)={//•
...
效果:
#image("assets/2025-09-19-21-57-14.png")


== 色底白字 帶下分隔綫的一級標題
#image("assets/2025-09-19-22-07-59.png")
...
效果爲:
#image("assets/2025-09-19-21-23-50.png")
第二行字並沒有加粗效果。
...
#image("assets/2025-09-19-21-25-20.png")

使用stroke設置基字體粗細時、 stroke默認下給文字添加的描邊爲黑色。當文字本身爲其他顏色時、添加的黑色描邊會影響效果。如
...
```
#image("assets/2025-09-19-21-31-25.png")
可見「紅色字」被描上了黑邊。
...
```
效果:
#image("assets/2025-09-19-21-32-54.png")
